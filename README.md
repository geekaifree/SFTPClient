...
<p align="center">
  <img src="assets/icon.svg" width="128" height="128" alt="SFTPClient">
</p>

<p align="center">
  <strong>SFTPClient</strong>
</p>
...
SFTPClient 是一款跨平台SFTPClient工具，基于 Flutter 框架开发，支持 Android、macOS、iOS 三平台。
